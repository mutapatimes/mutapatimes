...
.zse-stat:hover { border-color: var(--accent); box-shadow: 0 6px 22px rgba(0,0,0,0.06);
...
.zse-pricecell:hover { border-color: var(--accent); box-shadow: 0 6px 22px rgba(0,0,0,0.06);
  transform: translateY(-1px); }
...
<script defer src="/js/zse-eod.js?v=4"></script>
