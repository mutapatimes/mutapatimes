    ...
    return """
      <aside class="mt-context-module" role="complementary" aria-label="Why this matters">
        <div class="mt-context-module-inner">
          ...
          <p class="mt-context-deck">In the 2026 national budget, the government named &ldquo;Job Creation, Youth Entrepreneurship and Development, Creative Industry and Culture&rdquo; as one of its ten national priorities &mdash; the first time the creative industries have been placed at that level of the policy frame. The Ministry of Sport, Recreation, Arts and Culture was allocated ZiG&nbsp;841.4 million. The Pavilion of Zimbabwe in Venice is what that policy looks like in practice.</p>
          <div class="mt-context-stats">
            <div class="mt-context-stat">
              <p class="mt-context-stat-figure">ZiG&nbsp;841m</p>
              <p class="mt-context-stat-label">Allocated to the Ministry of Sport, Recreation, Arts and Culture in the 2026 budget, after Finance Minister Mthuli Ncube named the creative industries one of ten national priorities.</p>
            </div>
            <div class="mt-context-stat">
              <p class="mt-context-stat-figure">US$10.1m</p>
              <p class="mt-context-stat-label">Zimbabwe&rsquo;s art and craft exports in 2023, up from US$5.4m in 2020 (ZimTrade) &mdash; roughly 100% growth in three years. Buyers across South Africa, the US, Ethiopia, the UK, Spain, Namibia, China, Denmark and Germany.</p>
            </div>
            <div class="mt-context-stat">
              <p class="mt-context-stat-figure">US$70bn</p>
              <p class="mt-context-stat-label">Projected size of the global art and craft market by 2032, up from US$42.9bn in 2023 (5.6% CAGR). Zimbabwe is positioned to take a larger share if quality and capacity scale with demand.</p>
            </div>
            <div class="mt-context-stat">
              <p class="mt-context-stat-figure">8<small>th</small></p>
              <p class="mt-context-stat-label">Edition of the Pavilion of Zimbabwe at the Venice Biennale, 2026. The institutional supporters are Zimbabwean: the Higherlife Foundation and 1925 Glen Norah underwrite the eighth pavilion in full.</p>
            </div>
          </div>
