...
def page_head(title, canonical, desc, og_desc, schemas_inline, depth=2):
    ...
    <link rel="apple-touch-icon" href="{rel}icon.png?v=2">
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{rel}img/favicon-32x32.png?v=2">
    <link rel="icon" type="image/png" sizes="16x16" href="{rel}img/favicon-16x16.png?v=2">
