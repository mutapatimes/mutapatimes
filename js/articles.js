...
(function () {
  ...
  function articleShareButtons(meta) {
    var slug = new URLSearchParams(window.location.search).get("slug") || "";
    var rawUrl = BASE_URL + "/article.html?slug=" + encodeURIComponent(slug);
    var url = encodeURIComponent(rawUrl + '&utm_source=mutapatimes&utm_medium=article_share&utm_campaign=reader_share');
    var text = encodeURIComponent((meta.title || "Article") + " \u2014 The Mutapa Times \ud83c\uddff\ud83c\uddfc");
    var waText = encodeURIComponent((meta.title || "Article") + '\n\n' + rawUrl + '?utm_source=mutapatimes&utm_medium=whatsapp&utm_campaign=reader_share' + '\n\nvia The Mutapa Times \u2014 Zimbabwe news from 100+ sources \ud83c\uddff\ud83c\uddfc');
    return '<div class="article-share">'
      + '<span class="article-share-label">Share this article</span>'
      + '<div class="share-group">'
      + '<a href="https://api.whatsapp.com/send?text=' + waText + '" target="_blank" rel="noopener" class="whatsapp-btn" title="Share on WhatsApp" data-share-title="' + escapeHtml(meta.title || "Article") + '" data-share-url="' + escapeHtml(rawUrl) + '">'
